                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('aroma') is-invalid @enderror" 
                                          ...
                                          name="aroma" 
                                          rows="2"
                                          placeholder="Ej: Lavanda, Vainilla, Eucalipto">{{ old('aroma', $product->aroma) }}</textarea>
                                @error('aroma')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('colour') is-invalid @enderror" 
                                          ...
                                          name="colour" 
                                          rows="2"
                                          placeholder="Ej: Púrpura, Marrón, Verde">{{ old('colour', $product->colour) }}</textarea>
                                @error('colour')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-lg @error('size') is-invalid @enderror" 
                                    ...
                                    <option value="Pequeña" {{ old('size', $product->size) == 'Pequeña' ? 'selected' : '' }}>Pequeña</option>
                                    <option value="Mediana" {{ old('size', $product->size) == 'Mediana' ? 'selected' : '' }}>Mediana</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-lg @error('material') is-invalid @enderror" 
                                    ...
                                    <option value="Cera de soja" {{ old('material', $product->material) == 'Cera de soja' ? 'selected' : '' }}>Cera de soja</option>
                                    <option value="Cera de abeja" {{ old('material', $product->material) == 'Cera de abeja' ? 'selected' : '' }}>Cera de abeja</option>
                                    <option value="Parafina" {{ old('material', $product->material) == 'Parafina' ? 'selected' : '' }}>Parafina</option>
                                </select>
                                @error('material')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="4"
                                          placeholder="Describe las características y beneficios de tu producto...">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                @if($product->image)
                                    <div class="mb-3 p-3 bg-light rounded">
                                        ...
                                        <small class="text-muted mt-2 d-block">
                                            <i class="fas fa-info-circle me-1"></i>Imagen actual
                                        </small>
                                    </div>
                                @endif
                                <input type="file" 
                                ...
                                @enderror
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>Deja vacío para mantener la imagen actual. Formatos: JPG, PNG, GIF. Máximo 2MB.
                                </div>
                            </div>
                        </div>
